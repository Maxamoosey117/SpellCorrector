...
Your hashCode() method should produce hashCode values that satisfy the general contract of hashCode (as specified in the Javadoc for the hashCode method of Object) and are reasonably unique. You can achieve this by taking the index of the first non null node of the root and multiplying that index by the node count and word count of the Trie. The hashCode() function then returns this variable. You should not use toString() or similar methods inside your hashcode() method.
